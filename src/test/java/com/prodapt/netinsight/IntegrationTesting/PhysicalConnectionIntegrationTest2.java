...
public class PhysicalConnectionIntegrationTest2 {
    ...
    /**
     * Test method to Create Physical connection on ports between no shelf device 2
     * and multi shelf device 1.
     *
    ...
    public void createPhysicalConnectionOnPort() throws JsonProcessingException {
        String createPhysicalConnectionJson = "{\n " +
                "\"name\": \"Mock_ONT_3\",\n " +
                "\"deviceA\": \"noshelf_dev_2\",\n " +
                "\"deviceZ\": \"multishelf_dev_3\",\n " +
                "\"deviceAPort\": 1,\n " +
                "\"deviceZPort\": \"1/1/2/2\",\n " +
    ...
    /**
     * Test method to Create Physical connection on pluggables between no shelf device 2
     * and multi shelf device 1.
     *
     * @throws JsonProcessingException If there is an issue with JSON processing.
     */
    ...
    /**
     * Test method to Update Physical connection on ports between no shelf device 2
     * and multi shelf device 1 based on Connection Name.
     *
     * @throws JsonProcessingException If there is an issue with JSON processing.
     */
    @Test
    ...
    public void updatePhysicalConnectionOnPort() throws JsonProcessingException {
        ...
        connectionRestApis.updatePhysicalConnectionByName(existingOrder.getId(), "Mock_ONT_3", updatedPhysicalConnection);
    }

    /**
     * Test method to Update Physical connection on pluggables between no shelf device 2
     * and multi shelf device 1 based on Connection Name.
     *
     * @throws JsonProcessingException If there is an issue with JSON processing.
     */
    ...
    public void updatePhysicalConnectionOnPluggable() throws JsonProcessingException {
        ...
        //To update physical connection by using the connection name
        connectionRestApis.updatePhysicalConnectionByName(existingOrder.getId(), "Mock_ONT_4", updatedPhysicalConnection);
    }

    /**
     * Test method to Get Physical connection on ports between no shelf device 2
     * and multi shelf device 1.
     *
     * @throws JsonProcessingException If there is an issue with JSON processing.
     */
    ...
    public void getPhysicalConnectionOnPort() throws JsonProcessingException {
        ...
        PhysicalConnection actualPhysicalConnection = connectionRestApis.findPhysicalConnection("Mock_ONT_3");
    ...
    public void getPhysicalConnectionOnPluggable() throws JsonProcessingException {
        ...
        //To get the physical connection based on the name
        PhysicalConnection actualPhysicalConnection = connectionRestApis.findPhysicalConnection("Mock_ONT_4");
